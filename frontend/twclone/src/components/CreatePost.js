    ...
    <div className='w-[100%]'>
        ...
        <div className='flex items-center justify-evenly border-b border-gray-200'>
            <div className='cursor-pointer hover:bg-gray-200 w-full text-center px-4 py-3'> 
                <h1 className='font-semi-bold text-gray-600 text-lg'>For you</h1>
            </div>
            <div className='cursor-pointer hover:bg-gray-200 w-full text-center px-4 py-3'>
                <h1 className='font-semi-bold text-gray-600 text-lg '>Following</h1>
            </div>
        </div>
        ...
        <div> 
            ...
            <div className='flex items-center justify-between p-4 border-b border-gray-300'>
                ...
                <button className='bg-[#1D98F0] px-4 py-1 text-lg text-white tex border-none rounded-full'>Post</button>
            </div>
        </div>
